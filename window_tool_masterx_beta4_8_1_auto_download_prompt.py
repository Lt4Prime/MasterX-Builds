...
def obtener_rectangulo_ventana(
    hwnd
):
                        ...
                        def descargar_en_hilo():
                            try:
                                ...
                                def descarga_ok():
                                    ...
                                    try:
                                        os.startfile(os.path.dirname(destino))
                                    except Exception:
                                        pass
...
def cerrar_masterx(event=None):
    """Cierra MasterX completamente y libera sus hotkeys."""
    ...
    # Respaldo: si alguna librería deja un hilo vivo,
    # terminar el proceso unos milisegundos después.
    try:
        threading.Timer(
            0.35,
            lambda: os._exit(0)
